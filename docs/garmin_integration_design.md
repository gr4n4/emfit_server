...
> **가설: 0005·0006 은 돌봄자(요양보호사·가족)일 가능성이 높다.** 근거 — EMFIT 4대가 A시설 1·2 에
> 각각 `돌봄자`/`돌봄받는자` 쌍으로 배치돼 있고, 닉네임이 붙은 두 계정(0003·0004)은 걸음이 0인 반면
> 0005·0006 은 하루 6천 걸음 수준으로 활발하다. 확인되면 워치 4대가 EMFIT 4대와 1:1로 대응한다.
